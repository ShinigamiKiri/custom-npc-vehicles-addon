...
public class ModelPony<T extends EntityNpcPony>
extends EntityModel<T> {
    ...
    public void setupAnim(T npc, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        float f6;
        Resource resource;
        if (((EntityNpcPony)((Object)npc)).textureLocation != ((EntityNpcPony)((Object)npc)).checked && ((EntityNpcPony)((Object)npc)).textureLocation != null && (resource = (Resource)Minecraft.m_91087_().m_91098_().m_213713_(((EntityNpcPony)((Object)npc)).textureLocation).orElse(null)) != null) {
            try {
                BufferedImage bufferedimage = ImageIO.read(resource.m_215507_());
                ((EntityNpcPony)((Object)npc)).isPegasus = false;
                ((EntityNpcPony)((Object)npc)).isUnicorn = false;
                ...
                if (color.equals(color2)) {
                    ((EntityNpcPony)((Object)npc)).isPegasus = true;
                }
                if (color.equals(color3)) {
                    ((EntityNpcPony)((Object)npc)).isUnicorn = true;
                }
                if (color.equals(color4)) {
                    ((EntityNpcPony)((Object)npc)).isPegasus = true;
                    ((EntityNpcPony)((Object)npc)).isUnicorn = true;
                }
                ((EntityNpcPony)((Object)npc)).checked = ((EntityNpcPony)((Object)npc)).textureLocation;
            }
            catch (IOException bufferedimage) {
                // empty catch block
            }
        }
        this.isSleeping = ((EntityNPCInterface)((Object)npc)).m_5803_();
        this.isUnicorn = ((EntityNpcPony)((Object)npc)).isUnicorn;
        this.isPegasus = ((EntityNpcPony)((Object)npc)).isPegasus;
        this.isSneak = ((EntityNPCInterface)((Object)npc)).m_6047_();
        this.heldItemRight = ((EntityNPCInterface)((Object)npc)).m_21205_() == null ? 0 : 1;
        this.f_102609_ = npc.m_20159_();
        if (this.isSneak && (((EntityNpcPony)((Object)npc)).currentAnimation == 7 || ((EntityNpcPony)((Object)npc)).currentAnimation == 2)) {
            this.isSneak = false;
        }
        this.rainboom = false;
        if (this.isSleeping) {
        ...
        if (!this.isFlying || !this.isPegasus) {
            f8 = Mth.m_14089_((float)(limbSwing * 0.6662f + 3.141593f)) * 0.6f * limbSwingAmount;
            f9 = Mth.m_14089_((float)(limbSwing * 0.6662f)) * 0.6f * limbSwingAmount;
            f10 = Mth.m_14089_((float)(limbSwing * 0.6662f)) * 0.3f * limbSwingAmount;
            f11 = Mth.m_14089_((float)(limbSwing * 0.6662f + 3.141593f)) * 0.3f * limbSwingAmount;
            ...
            if (limbSwingAmount < 0.9999f) {
                this.rainboom = false;
                f8 = Mth.m_14031_((float)(0.0f - limbSwingAmount * 0.5f));
                f9 = Mth.m_14031_((float)(0.0f - limbSwingAmount * 0.5f));
                f10 = Mth.m_14031_((float)(limbSwingAmount * 0.5f));
                f11 = Mth.m_14031_((float)(limbSwingAmount * 0.5f));
            } else {
                this.rainboom = true;
                f8 = 4.712f;
                f9 = 4.712f;
        ...
        for (int i = 0; i < this.Tail.length; ++i) {
            this.Tail[i].zRot = this.rainboom ? 0.0f : Mth.m_14089_((float)(limbSwing * 0.8f)) * 0.2f * limbSwingAmount;
        }
        ...
        if (this.isSneak && !this.isFlying) {
            ...
            for (int i4 = 0; i4 < this.LeftWingExt.length; ++i4) {
                this.LeftWingExt[i4].xRot = (float)((double)f17 + 2.3561947345733643);
            ...
            for (int i5 = 0; i5 < this.LeftWingExt.length; ++i5) {
                this.RightWingExt[i5].xRot = (float)((double)f17 + 2.3561947345733643);
            ...
            if (this.isPegasus) {
                if (!this.isFlying) {
                    for (int k3 = 0; k3 < this.LeftWing.length; ++k3) {
                        this.LeftWing[k3].xRot = (float)((double)f18 + 1.5707964897155762);
                        this.LeftWing[k3].y = f24 + 13.0f;
                        this.LeftWing[k3].z = f30 - 3.0f;
                    }
                    for (int l3 = 0; l3 < this.RightWing.length; ++l3) {
                        this.RightWing[l3].xRot = (float)((double)f18 + 1.5707964897155762);
                    ...
                    for (int j4 = 0; j4 < this.LeftWingExt.length; ++j4) {
                        this.LeftWingExt[j4].xRot = (float)((double)f18 + 1.5707964897155762);
                    ...
                    for (int j5 = 0; j5 < this.RightWingExt.length; ++j5) {
                        this.RightWingExt[j5].xRot = (float)((double)f18 + 1.5707964897155762);
            ...
            this.LeftLeg.y = 8.0f;
            float f36 = Mth.m_14089_((float)(ageInTicks * 0.09f)) * 0.05f + 0.05f;
            float f39 = Mth.m_14031_((float)(ageInTicks * 0.067f)) * 0.05f;
            this.unicornarm.zRot += f36;
            this.unicornarm.xRot += f39;
            if (this.isPegasus && this.isFlying) {
                this.WingRotateAngleY = Mth.m_14031_((float)(ageInTicks * 0.067f * 8.0f)) * 1.0f;
                this.WingRotateAngleZ = Mth.m_14031_((float)(ageInTicks * 0.067f * 8.0f)) * 1.0f;
            ...
            for (int k5 = 0; k5 < this.Tail.length; ++k5) {
                ...
                this.Tail[k5].y = f57;
                this.Tail[k5].z = f59;
                this.Tail[k5].xRot = this.rainboom ? 1.571f + 0.1f * Mth.m_14031_((float)limbSwing) : f61;
            }
        ...
        if (this.aimedBow) {
            ...
            this.unicornarm.zRot += Mth.m_14089_((float)(f31 * 0.09f)) * 0.05f + 0.05f;
            this.unicornarm.xRot += Mth.m_14031_((float)(f31 * 0.067f)) * 0.05f;
            if (!this.isUnicorn) {
    ...
    public void m_7695_(PoseStack mStack, VertexConsumer iVertex, int lightmapUV, int packedOverlayIn, float red, float green, float blue, float alpha) {
        mStack.m_85836_();
        if (this.isSleeping) {
            mStack.m_252781_(Axis.f_252529_.m_252977_(90.0f));
            mStack.m_252880_(0.0f, -0.5f, -0.9f);
        }
