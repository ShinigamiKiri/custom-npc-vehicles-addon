...
implements ITextfieldListener {
    ...
    public void m_7856_() {
        super.m_7856_();
        this.addLabel(new GuiLabel(1, "stats.meleestrength", this.guiLeft + 5, this.guiTop + 15, "guihint.npcdamage"));
        this.addTextField(new GuiTextFieldNop(1, (Screen)this, this.guiLeft + 105, this.guiTop + 10, 100, 18, "" + this.stats.getStrength()));
        this.getTextField((int)1).numbersOnly = true;
        this.getTextField(1).setMinMaxDefault(0, Integer.MAX_VALUE, 5);
        this.addLabel(new GuiLabel(2, "stats.meleerange", this.guiLeft + 5, this.guiTop + 45, "guihint.npcattackrange"));
        this.addTextField(new GuiTextFieldNop(2, (Screen)this, this.guiLeft + 105, this.guiTop + 40, 100, 18, "" + this.stats.getRange()));
        this.getTextField((int)2).numbersOnly = true;
        this.getTextField(2).setMinMaxDefault(1, 30, 2);
        this.addLabel(new GuiLabel(3, "stats.meleespeed", this.guiLeft + 5, this.guiTop + 75, "guihint.npcattackspeed"));
        this.addTextField(new GuiTextFieldNop(3, (Screen)this, this.guiLeft + 105, this.guiTop + 70, 100, 18, "" + this.stats.getDelay()));
        this.getTextField((int)3).numbersOnly = true;
        this.getTextField(3).setMinMaxDefault(1, 1000, 20);
        this.addLabel(new GuiLabel(4, "enchantment.minecraft.knockback", this.guiLeft + 5, this.guiTop + 105, "guihint.npcknockback"));
        this.addTextField(new GuiTextFieldNop(4, (Screen)this, this.guiLeft + 105, this.guiTop + 100, 100, 18, "" + this.stats.getKnockback()));
        this.getTextField((int)4).numbersOnly = true;
        this.getTextField(4).setMinMaxDefault(0, 4, 0);
        this.addLabel(new GuiLabel(5, "stats.meleeeffect", this.guiLeft + 5, this.guiTop + 135, "guihint.npceffect"));
        ...
        if (this.stats.getEffectType() != 0) {
            ...
            this.addTextField(new GuiTextFieldNop(6, (Screen)this, this.guiLeft + 85, this.guiTop + 160, 50, 18, "" + this.stats.getEffectTime()));
