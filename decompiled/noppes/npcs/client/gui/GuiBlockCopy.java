...
ITextfieldListener {
    ...
    public GuiBlockCopy(BlockPos pos) {
        ...
        this.tile = (TileCopy)this.player.m_9236_().m_7702_(pos);
    ...
    public void m_7856_() {
        ...
        this.getTextField(0).setMinMaxDefault(0, 1000, 10);
        ...
        this.getTextField(1).setMinMaxDefault(0, 1000, 10);
        ...
        this.getTextField(2).setMinMaxDefault(0, 1000, 10);
