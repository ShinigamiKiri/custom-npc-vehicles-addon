...
GuiSelectionListener {
    ...
    public void m_7856_() {
        ...
        this.addTextField(new GuiTextFieldNop(1, (Screen)this, this.guiLeft + 60, this.guiTop + 14, 180, 20, this.mail.subject));
        this.addLabel(new GuiLabel(0, "mailbox.sender", this.guiLeft + 4, this.guiTop + 41));
        this.addTextField(new GuiTextFieldNop(0, (Screen)this, this.guiLeft + 60, this.guiTop + 36, 180, 20, this.mail.sender));
        ...
        if (this.player.f_36096_ instanceof ContainerMail) {
            ContainerMail container = (ContainerMail)this.player.f_36096_;
