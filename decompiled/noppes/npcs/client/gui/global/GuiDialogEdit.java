...
implements ITextfieldListener {
    ...
    public void m_7856_() {
        ...
        this.addTextField(new GuiTextFieldNop(1, (Screen)this, this.guiLeft + 46, this.guiTop + 3, 220, 20, this.dialog.title));
        ...
        this.addTextField(new GuiTextFieldNop(2, (Screen)this, this.guiLeft + 4, this.guiTop + 148, 264, 20, this.dialog.sound));
        ...
        int y = this.guiTop + 4;
        this.addButton(new GuiButtonNop(this, 10, this.guiLeft + 330, y += 22, 50, 20, "selectServer.edit"));
        this.addLabel(new GuiLabel(10, "advMode.command", this.guiLeft + 214, y + 5));
        this.addButton(new GuiButtonYesNo((IGuiInterface)this, 11, this.guiLeft + 330, y += 22, this.dialog.hideNPC));
        this.addLabel(new GuiLabel(11, "dialog.hideNPC", this.guiLeft + 214, y + 5));
        this.addButton(new GuiButtonYesNo((IGuiInterface)this, 12, this.guiLeft + 330, y += 22, this.dialog.showWheel));
        this.addLabel(new GuiLabel(12, "dialog.showWheel", this.guiLeft + 214, y + 5));
        this.addButton(new GuiButtonYesNo((IGuiInterface)this, 15, this.guiLeft + 330, y += 22, this.dialog.disableEsc));
    ...
    public void buttonEvent(GuiButtonNop guibutton) {
        ...
        if (id == 15) {
            boolean bl = this.dialog.disableEsc = button.getValue() == 1;
        }
        if (id == 13) {
