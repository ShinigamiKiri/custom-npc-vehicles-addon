...
implements IGuiData {
    ...
    public GuiNpcMobSpawnerAdd(CompoundTag compound) {
        this.toClone = EntityType.m_20642_((CompoundTag)compound, (Level)Minecraft.m_91087_().f_91073_).orElse(null);
    ...
    public void m_7856_() {
        super.m_7856_();
        String name = this.toClone.m_7755_().getString();
        ...
        if (id == 0) {
            ...
            if (!serverSide) {
                if (ClientCloneController.Instance.getCloneData(null, name, tab) != null) {
                    this.setScreen((Screen)new ConfirmScreen(this::accept, (Component)Component.m_237115_((String)""), (Component)Component.m_237115_((String)"clone.overwrite")));
                } else {
                    this.accept(true);
                }
            } else {
    ...
    public void setGuiData(CompoundTag compound) {
        if (compound.m_128441_("NameExists")) {
            if (compound.m_128471_("NameExists")) {
                this.setScreen((Screen)new ConfirmScreen(this::accept, (Component)Component.m_237115_((String)""), (Component)Component.m_237115_((String)"clone.overwrite")));
            } else {
                this.accept(true);
            }
