...
implements Toast {
    ...
    public Toast.Visibility m_7172_(GuiGraphics graphics, ToastComponent toastGui, long delta) {
        ...
        graphics.m_280218_(f_94893_, 0, 0, 0, 32 * this.type, 160, 32);
        int color1 = -256;
        int color2 = -1;
        ...
        graphics.m_280488_(toastGui.m_94929_().f_91062_, this.title, 18, 7, color1);
        graphics.m_280488_(toastGui.m_94929_().f_91062_, this.subtitle, 18, 18, color2);
