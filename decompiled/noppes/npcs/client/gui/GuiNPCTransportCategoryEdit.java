...
extends GuiNPCInterface {
    ...
    public void m_7856_() {
        super.m_7856_();
        this.addTextField(new GuiTextFieldNop(1, (Screen)this, this.f_96543_ / 2 - 40, 100, 140, 20, this.name));
        this.addLabel(new GuiLabel(1, "Title:", this.f_96543_ / 2 - 100 + 4, 105, 0xFFFFFF));
