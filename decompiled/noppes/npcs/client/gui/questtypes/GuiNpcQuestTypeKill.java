...
ICustomScrollListener {
    ...
    public void m_7856_() {
        ...
        for (String name : this.quest.targets.keySet()) {
            ...
            this.addTextField(new GuiTextFieldNop(i + 3, (Screen)this, this.guiLeft + 186, this.guiTop + 70 + i * 22, 24, 20, "" + this.quest.targets.get(name)));
        ...
        for (EntityType<? extends Entity> ent : EntityUtil.getAllEntitiesClassesNoNpcs((Level)this.f_96541_.f_91073_).keySet()) {
