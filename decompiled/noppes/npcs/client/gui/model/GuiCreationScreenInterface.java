...
implements ISliderListener {
    ...
    public void m_7856_() {
        ...
        if (this.entity == null) {
            ...
            if (!gui.getData(this.entity).isEmpty()) {
                ...
                this.f_96541_.m_91152_((Screen)new GuiCreationEntities(this.npc));
                return;
            }
        }
        if (this.entity == null) {
        ...
        this.getButton((int)this.active).f_93623_ = false;
        ...
        this.addLabel(new GuiLabel(0, Message, this.guiLeft + 120, this.guiTop + this.imageHeight - 10, 0xFF0000, this.imageWidth - 120, 20));
    ...
    public void m_88315_(GuiGraphics graphics, int x, int y, float f) {
        ...
        if (entity == null) {
            ...
            EntityUtil.Copy((LivingEntity)this.npc, entity);
        }
        this.drawNpc(graphics, (LivingEntity)this.npc, this.xOffset + 200, 200, 2.0f, (int)(-rotation * 360.0f - 180.0f));
    }
