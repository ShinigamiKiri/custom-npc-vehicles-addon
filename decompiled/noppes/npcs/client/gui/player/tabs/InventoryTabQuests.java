...
extends AbstractTab {
    public Component displayString = Component.m_237115_((String)"quest.quest").m_130946_(" (").m_7220_(ClientProxy.QuestLog.getKey().m_84875_()).m_130946_(")");

    public InventoryTabQuests() {
        super(2, 0, 0, new ItemStack((ItemLike)Items.f_42517_));
    }

    @Override
    public void onTabClicked() {
        Minecraft mc = Minecraft.m_91087_();
        mc.m_91152_((Screen)new GuiQuestLog((Player)mc.f_91074_));
    }
