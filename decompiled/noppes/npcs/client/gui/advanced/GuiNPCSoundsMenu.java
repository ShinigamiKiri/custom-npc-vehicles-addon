...
implements ITextfieldListener {
    ...
    public void m_7856_() {
        ...
        this.addTextField(new GuiTextFieldNop(0, (Screen)this, this.guiLeft + 80, this.guiTop + 15, 200, 20, this.npc.advanced.getSound(0)));
        ...
        this.addTextField(new GuiTextFieldNop(2, (Screen)this, this.guiLeft + 80, this.guiTop + 40, 200, 20, this.npc.advanced.getSound(1)));
        ...
        this.addTextField(new GuiTextFieldNop(3, (Screen)this, this.guiLeft + 80, this.guiTop + 65, 200, 20, this.npc.advanced.getSound(2)));
        ...
        this.addTextField(new GuiTextFieldNop(4, (Screen)this, this.guiLeft + 80, this.guiTop + 90, 200, 20, this.npc.advanced.getSound(3)));
        ...
        this.addTextField(new GuiTextFieldNop(5, (Screen)this, this.guiLeft + 80, this.guiTop + 115, 200, 20, this.npc.advanced.getSound(4)));
        ...
        this.addButton(new GuiButtonNop((IGuiInterface)this, 6, this.guiLeft + 120, this.guiTop + 145, 80, 20, new String[]{"gui.no", "gui.yes"}, this.npc.advanced.disablePitch ? 0 : 1));
    }
