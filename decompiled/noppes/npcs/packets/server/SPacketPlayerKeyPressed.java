...
extends PacketServerBasic {
    ...
    public static void encode(SPacketPlayerKeyPressed msg, FriendlyByteBuf buf) {
        ...
        buf.m_130070_(msg.openGui == null ? "" : msg.openGui);
    }

    public static SPacketPlayerKeyPressed decode(FriendlyByteBuf buf) {
        return new SPacketPlayerKeyPressed(buf.readInt(), buf.readBoolean(), buf.readBoolean(), buf.readBoolean(), buf.readBoolean(), buf.readBoolean(), buf.m_130136_(Short.MAX_VALUE));
    }
