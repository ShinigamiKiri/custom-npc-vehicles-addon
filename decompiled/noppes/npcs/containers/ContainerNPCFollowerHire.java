...
extends ContainerNpcInterface {
    ...
    public ContainerNPCFollowerHire(int containerId, Inventory playerInventory, int entityId) {
        ...
        this.m_38897_(new SlotNpcMercenaryCurrency(this.role, (Container)this.currencyMatrix, 0, 44, 35));
        for (int i1 = 0; i1 < 3; ++i1) {
            for (int l1 = 0; l1 < 9; ++l1) {
                this.m_38897_(new Slot((Container)this.player.m_150109_(), l1 + i1 * 9 + 9, 8 + l1 * 18, 84 + i1 * 18));
            }
        }
