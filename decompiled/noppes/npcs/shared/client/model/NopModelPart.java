...
public class NopModelPart {
    ...
    public void addChild(String name, NopModelPart p_78792_1_) {
        this.children.put((Object)name, (Object)p_78792_1_);
    }

    public void addChild(NopModelPart p_78792_1_) {
        this.children.put((Object)UUID.randomUUID().toString(), (Object)p_78792_1_);
    }
    ...
    private void addBox(int p_228305_1_, int p_228305_2_, float p_228305_3_, float p_228305_4_, float p_228305_5_, float p_228305_6_, float p_228305_7_, float p_228305_8_, float p_228305_9_, float p_228305_10_, float p_228305_11_, boolean p_228305_12_, boolean p_228305_13_) {
        this.cubes.add((Object)new ModelBox(p_228305_1_, p_228305_2_, p_228305_3_, p_228305_4_, p_228305_5_, p_228305_6_, p_228305_7_, p_228305_8_, p_228305_9_, p_228305_10_, p_228305_11_, p_228305_12_, this.xTexSize, this.yTexSize));
    }
    ...
    public void render(PoseStack p_228309_1_, VertexConsumer p_228309_2_, int p_228309_3_, int p_228309_4_, float p_228309_5_, float p_228309_6_, float p_228309_7_, float p_228309_8_) {
        if (!(!this.visible || this.cubes.isEmpty() && this.children.isEmpty())) {
            ...
            this.compile(p_228309_1_.m_85850_(), p_228309_2_, p_228309_3_, p_228309_4_, p_228309_5_, p_228309_6_, p_228309_7_, p_228309_8_);
    ...
    public void translateAndRotate(PoseStack p_228307_1_) {
        p_228307_1_.m_85837_((double)(this.x / 16.0f), (double)(this.y / 16.0f), (double)(this.z / 16.0f));
        if (this.zRot != 0.0f) {
            p_228307_1_.m_252781_(Axis.f_252403_.m_252961_(this.zRot));
        }
        if (this.yRot != 0.0f) {
            p_228307_1_.m_252781_(Axis.f_252436_.m_252961_(this.yRot));
        }
        if (this.xRot != 0.0f) {
            p_228307_1_.m_252781_(Axis.f_252529_.m_252961_(this.xRot));
        }
        p_228307_1_.m_85841_(this.scale.x, this.scale.y, this.scale.z);
    }
    ...
    private void compile(PoseStack.Pose p_228306_1_, VertexConsumer p_228306_2_, int p_228306_3_, int p_228306_4_, float p_228306_5_, float p_228306_6_, float p_228306_7_, float p_228306_8_) {
        Matrix4f matrix4f = p_228306_1_.m_252922_();
        Matrix3f matrix3f = p_228306_1_.m_252943_();
        for (ModelBox MpmModelPart$modelbox : this.cubes) {
            for (TexturedQuad MpmModelPart$texturedquad : MpmModelPart$modelbox.polygons) {
                ...
                for (int i = 0; i < 4; ++i) {
                    ...
                    p_228306_2_.m_5954_(vector4f.x(), vector4f.y(), vector4f.z(), p_228306_5_, p_228306_6_, p_228306_7_, p_228306_8_, MpmModelPart$positiontexturevertex.u, MpmModelPart$positiontexturevertex.v, p_228306_4_, p_228306_3_, f, f1, f2);
                }
            }
        }
    }
