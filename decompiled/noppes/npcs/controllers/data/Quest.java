...
IQuest {
    ...
    public void readNBTPartial(CompoundTag compound) {
        ...
        this.setType(compound.m_128451_("Type"));
        this.title = compound.m_128461_("Title");
        this.logText = compound.m_128461_("Text");
        this.completeText = compound.m_128461_("CompleteText");
        this.completerNpc = compound.m_128461_("CompleterNpc");
        this.command = compound.m_128461_("QuestCommand");
        this.nextQuestid = compound.m_128451_("NextQuestId");
        this.randomReward = compound.m_128471_("RandomReward");
        this.rewardExp = compound.m_128451_("RewardExp");
        this.rewardItems.setFromNBT(compound.m_128469_("Rewards"));
        this.completion = EnumQuestCompletion.values()[compound.m_128451_("QuestCompletion")];
        this.repeat = EnumQuestRepeat.values()[compound.m_128451_("QuestRepeat")];
        this.questInterface.readAdditionalSaveData(compound);
        this.factionOptions.load(compound.m_128469_("QuestFactionPoints"));
        this.mail.readNBT(compound.m_128469_("QuestMail"));
    }
    ...
    public CompoundTag writeToNBTPartial(CompoundTag compound) {
        ...
        compound.m_128359_("Text", this.logText);
        compound.m_128359_("CompleteText", this.completeText);
        compound.m_128359_("CompleterNpc", this.completerNpc);
        compound.m_128405_("NextQuestId", this.nextQuestid);
        compound.m_128405_("RewardExp", this.rewardExp);
        compound.m_128365_("Rewards", (Tag)this.rewardItems.getToNBT());
        compound.m_128359_("QuestCommand", this.command);
        compound.m_128379_("RandomReward", this.randomReward);
        compound.m_128405_("QuestCompletion", this.completion.ordinal());
        compound.m_128405_("QuestRepeat", this.repeat.ordinal());
        this.questInterface.addAdditionalSaveData(compound);
        compound.m_128365_("QuestFactionPoints", (Tag)this.factionOptions.save(new CompoundTag()));
        compound.m_128365_("QuestMail", (Tag)this.mail.writeNBT());
        return compound;
    }
    ...
    public IQuestObjective[] getObjectives(IPlayer player) {
        ...
        return this.questInterface.getObjectives((Player)player.getMCEntity());
    }
