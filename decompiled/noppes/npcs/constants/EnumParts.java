...
public enum EnumParts {
    ...
    public static EnumParts FromName(String name) {
        for (EnumParts e : EnumParts.values()) {
    ...
    public static MpmPartData convertOldPart(CompoundTag compound) {
        ...
        part.color = ColorUtil.colorToRgb(compound.m_128451_("Color"));
        part.usePlayerSkin = compound.m_128471_("PlayerTexture");
        String name = compound.m_128461_("PartName");
        byte type = compound.m_128445_("Type");
        byte pattern = compound.m_128445_("Pattern");
        ...
        if (name.equals("breasts")) {
            part.partId = new ResourceLocation(SharedReferences.modid(), (String)(type == 0 ? "parts/body/breasts.json" : "parts/body/breasts" + (type + 1) + ".json"));
        }
