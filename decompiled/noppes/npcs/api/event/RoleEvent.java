...
extends CustomNPCsEvent {
    ...
    public static class BankUpgradedEvent
    extends RoleEvent {
    ...
    public static class BankUnlockedEvent
    extends RoleEvent {
        public final int slot;
    ...
    extends RoleEvent {
        ...
        public TradeFailedEvent(Player player, ICustomNpc npc, ItemStack sold, ItemStack currency1, ItemStack currency2) {
            super(player, npc);
            this.currency1 = currency1.m_41619_() ? null : NpcAPI.Instance().getIItemStack(currency1.m_41777_());
            this.currency2 = currency2.m_41619_() ? null : NpcAPI.Instance().getIItemStack(currency2.m_41777_());
            this.sold = NpcAPI.Instance().getIItemStack(sold.m_41777_());
        }
    }
    ...
    public static class FollowerFinishedEvent
    extends RoleEvent {
    ...
    @Cancelable
    public static class FollowerHireEvent
    extends RoleEvent {
        public int days;
    ...
    @Cancelable
    public static class MailmanEvent
    extends RoleEvent {
    ...
    @Cancelable
    public static class TransporterUnlockedEvent
    extends RoleEvent {
    ...
    @Cancelable
    public static class TransporterUseEvent
    extends RoleEvent {
