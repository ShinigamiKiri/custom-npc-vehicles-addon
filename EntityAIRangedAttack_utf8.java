...
extends Goal {
    ...
    public boolean m_8036_() {
        ...
        if (this.attackTarget == null || !this.attackTarget.m_6084_() || !this.npc.isInRange((Entity)this.attackTarget, (double)this.npc.stats.aggroRange) || this.npc.inventory.getProjectile() == null) {
            return false;
        }
        ...
        return this.npc.stats.ranged.getMeleeRange() < 1 || !this.npc.isInRange((Entity)this.attackTarget, (double)this.npc.stats.ranged.getMeleeRange());
    }
